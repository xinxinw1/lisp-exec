...
(function (win, udf){
  ...
  function par(a, b, env){
    ...
    if (is(car(a), "o"))return lis(cons(cadr(a), nilp(b)?evl(nth("2", a), env):b));
  ...
  function afn(a, x){
    var env = {0: rp(a, "2")};
    return evlenv(rp(a, "1"), tobj(par(rp(a, "0"), x, env), env));
  }
